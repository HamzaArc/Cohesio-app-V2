...
// --- TIME OFF MIGRATION: The Time Off link is now uncommented ---
const navItems = [
  ...
  return (
    <div className="w-64 bg-white text-white flex flex-col p-4 border-r border-gray-200">
      ...
      <div className="mt-auto">
        <button onClick={() => supabase.auth.signOut()} className="flex items-center w-full p-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900">
